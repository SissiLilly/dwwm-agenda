...
if($_SERVER['REQUEST_METHOD'] === 'POST')
    ...
    */
    ...
    // Si le jeton de sécurité provenant du formulaire n'est pas le même que celui généré par le système
...
<?php $keywords = "Agenda, Contacts, php, php8, Project, DWWM"; ?>
...
<main class="container">
    ...
    <div class="container">
        <div class="row">
            <!-- ici on fait du responsive design, 
            sur les écrans moyen tu prends 8 colonnes, sur les grands 7 colonnes -->
            <div class="col-md-8 col-lg-7 mx-auto p-4 shadow bg-white">
                <form method="POST">
                  ...
                  <div class="mb-3 d-done">
                    <input type="hidden" name="create_form_csrf_token" value="<?php $SESSION['create_form_csrf_token'] ?>">
                  </div>

                  <div class="mb-3 d-done">
                    <input type="hidden" name="create_form_honey_pot" value="<?php $SESSION['create_form_honey_pot'] ?>">
                  </div>
